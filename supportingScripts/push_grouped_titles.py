#!/usr/bin/env python3
"""
push_grouped_titles.py

Pushes each JSON file from the "grouped_titles/" folder into MongoDB.
...
# Try existing db connection if available
try:
...
FOLDER = "grouped_titles"
COLLECTION_NAME = "grouped_titles_data"
collection = db[COLLECTION_NAME]


def extract_date(filename: str):
    """Extracts YYYY-MM-DD from filename like grouped_titles_2025-10-18.json"""
...
def main():
    ...
    print("\n🎯 Done pushing grouped_titles to MongoDB.")
