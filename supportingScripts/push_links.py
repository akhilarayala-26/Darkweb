...
Pushes each JSON file from the "links/" folder into MongoDB.
...
FOLDER = "links"
COLLECTION_NAME = "links_data"
collection = db[COLLECTION_NAME]


def extract_date(filename: str):
    """Extracts YYYY-MM-DD from filename like links_2025-10-18.json"""
...
def main():
    ...
    print("\n🎯 Done pushing links data to MongoDB.")
